...
When scrolling is triggered on the <code>html</code> element itself, we&rsquo;d like the behavior of the scroll to be as fluid as possible.</p>
...
<li>Set <code>body</code>&lsquo;s font-family to <code>font-family-base</code></li>
...
<p>Style the anchor elements so the text isn&rsquo;t decorated with anything</p>
...
<p>Normalize your CSS file using <a href="/rltoken/0UITCJASLDBEvDQdP_pwiw" title="necolas&#39; normalize.css" target="_blank">necolas&rsquo; normalize.css</a> with <a href="/rltoken/SE65V_9HBDJxYAuoJfK2YQ" title="this version" target="_blank">this version</a>.</p>
...
<li>Set <code>.section-header</code>&lsquo;s pad all 4 sides with <code>section-header-padding</code></li>
...
<p>Style the data-section-theme=&ldquo;dark&rdquo; with these rules:</p>
